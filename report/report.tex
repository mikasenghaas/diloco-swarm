...
\begin{abstract}
  ...
  synchronizing gradients up to 50 times less frequently. We publicly release a
  minimal PyTorch implementation of various traditional and state-of-the-art
  distributed training methods as an educational resource, as well as a starting
  point for further research in decentralized AI.
\end{abstract}
...
DiLoCo~\cite{douillard2023} experiments.
...
less data~\cite{nanogpt2024,moddednanogpt2024}.

% Model
For all experiments, we use the GPT-2 family of models~\cite{radford2019} which
...
DiLoCo~\cite{douillard2023}: The default optimizer outer
...
DiLoCo~\cite{douillard2023}. This might not always be fair, and lead to
