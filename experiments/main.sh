...
torchrun --nproc_per_node 8 src/train.py \
    ...
    --train.inner_optimizer.lr 4e-4 \
    --train.scheduler.enable true \
    --train.scheduler.num_warmup_steps 100 \
    ...
    --eval.eval_size 0.001 \
    --sample.enable true \
    --sample.every_n_steps 400 \
    --logging.wandb.enable true \
    --logging.wandb.tags "Experiment 1,DP,8xUpdates"
